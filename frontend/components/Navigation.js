  ...
  return (
    <div className="py-4 w-full">
      <ul className="space-y-2">
        ...
        <li>
          <a onClick={() => setProp(props.setDrive)} className="flex h-14 items-center p-2 text-base font-normal text-black rounded-lg dark:text-black hover:text-white hover:bg-orange-100 dark:hover:bg-orange-300 hover:no-underline">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <li>
          <a onClick={() => setProp(props.setRegistration)} className="flex h-14  items-center p-2 text-base font-normal text-black rounded-lg dark:text-black hover:text-white hover:bg-orange-100 dark:hover:bg-orange-300 hover:no-underline">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <li>
          <a onClick={() => setProp(props.setProfile)} className="flex h-14  items-center p-2 text-base font-normal text-black rounded-lg dark:text-black hover:text-white hover:bg-orange-100 dark:hover:bg-orange-300 hover:no-underline">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V8a2 2 0 00-2-2h-5L9 4H4zm7 5a1 1 0 10-2 0v1H8a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V9z" />
            </svg>
